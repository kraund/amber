describe("Exercise 1", function () {
    it("should have the right title", async function () {
        ...
        var tempString = await arrAllButtonsText.slice(0, 1).split(" ")
        var ourValues = [`${tempString[0]} ${tempString[1]}`, `${tempString[2]} ${tempString[3]}`, `${tempString[4]} ${tempString[5]}`, `${tempString[6]} ${tempString[7]}`, `${tempString[8]} ${tempString[9]}`, `${tempString[10]} ${tempString[11]} ${tempString[12]}`, `${tempString[13]} ${tempString[14]} ${tempString[15]} ${tempString[16]}`, `${tempString[17]} ${tempString[18]}`]

describe("Exercise 1", function () {
    it("should have the right title", async function () {
        ...
        const name_group2 = await arrAllButtonsText.slice(1, 9)
        const name_group3 = await arrAllButtonsText.slice(1, 9)
        const name_group4 = await arrAllButtonsText.slice(1, 9)

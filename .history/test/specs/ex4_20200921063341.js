describe("Exercise 1", function () {
    it("should have the right title", async function () {
        ...
        await nxutils.asyncForEach(arrAllButtons, async obj => {
            ...
            const value2Clean = await value.replace(/(\r\n|\n|\r)/gm, "")
            arrAllButtonsText.push(value2)
        });
        const name_group1 = await arrAllButtonsText.slice(2, 9)
        const name_group2 = await arrAllButtonsText.slice(2, 9)
        const name_group3 = await arrAllButtonsText.slice(2, 9)
        const name_group4 = await arrAllButtonsText.slice(2, 9)
        console.log(name_group1)

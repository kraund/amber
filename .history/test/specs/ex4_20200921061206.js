describe("Exercise 1", function () {
    it("should have the right title", async function () {
        ...
        const group1 = await arrAllButtonsText.slice(1, 9)
        const group2 = await arrAllButtonsText.slice(10, 19)
        const group3 = await arrAllButtonsText.slice(20, 29)
        const group4 = await arrAllButtonsText.slice(30, 39)
